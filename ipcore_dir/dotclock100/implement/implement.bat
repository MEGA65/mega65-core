...
xst -ifn xst.scr
move dotclock100_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dotclock100_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dotclock100_exdes.ucf dotclock100_exdes

echo 'Running map'
map -timing -pr b dotclock100_exdes -o mapped.ncd
