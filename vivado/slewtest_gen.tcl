...
set files [list \
 ...
 "[file normalize "$origin_dir/src/vhdl/slewtest.vhdl"]"\
...
set file "[file normalize "$origin_dir/src/vhdl/slewtest.xdc"]"
set file_imported [add_files -fileset constrs_1 $file]
set file "vhdl/slewtest.xdc"
