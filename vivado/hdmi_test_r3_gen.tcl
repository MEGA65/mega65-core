...
set script_file "hdmi_test_r3.tcl"
...
set files [list \
 "[file normalize "$origin_dir/src/vhdl/clocking100_25mhz.vhdl"]"\
 ...
 "[file normalize "$origin_dir/src/vhdl/hdmi_test_r3.vhdl"]"\
...
set file "vhdl/clocking100_25mhz.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "vhdl/hdmi_test_r3.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
