...
set files [list \
 ...
 "[file normalize "$origin_dir/src/vhdl/m65debug.vhdl"]"\
...
set file "[file normalize "$origin_dir/src/vhdl/m65debug.xdc"]"
set file_imported [add_files -fileset constrs_1 $file]
set file "vhdl/m65debug.xdc"
