...
set files [list \
 ...
 "[file normalize "$origin_dir/src/vhdl/testr2.vhdl"]"\
...
set file "[file normalize "$origin_dir/src/vhdl/testr2.xdc"]"
set file_imported [add_files -fileset constrs_1 $file]
set file "vhdl/testr2.xdc"
