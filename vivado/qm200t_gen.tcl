...
set files [list \
 ...
 "[file normalize "$origin_dir/src/vhdl/qm200t.vhdl"]"\
...
set file "[file normalize "$origin_dir/src/vhdl/qm200t.xdc"]"
set file_imported [add_files -fileset constrs_1 $file]
set file "vhdl/qm200t.xdc"
