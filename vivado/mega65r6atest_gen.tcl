...
set project_name "mega65r6atest"
...
set script_file "mega65r6atest.tcl"
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/vhdl/mega65r6a_test.vhdl"]"\
 "[file normalize "$origin_dir/src/vhdl/i2c_dump16_uart.vhdl"]"\
...
set file "vhdl/mega65r6a_test.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "vhdl/i2c_dump16_uart.vhdl"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
