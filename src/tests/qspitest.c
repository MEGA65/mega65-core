...
{
  POKE(BITBASH_PORT,PEEK(BITBASH_PORT)|0x10);
}
...
{
  POKE(BITBASH_PORT,PEEK(BITBASH_PORT)&(0xFF-0x20));
}

void spi_clock_high(void)
{
  POKE(BITBASH_PORT,PEEK(BITBASH_PORT)|0x20);
}

void spi_cs_low(void)
{
  POKE(BITBASH_PORT,PEEK(BITBASH_PORT)&(0xFF-0x40));
}
