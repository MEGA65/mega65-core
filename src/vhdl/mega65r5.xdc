...
set_property -dict {PACKAGE_PIN T20 IOSTANDARD LVCMOS33} [get_ports cart_reset_en_n]
...
create_generated_clock -name sdram_clk -multiply_by 1 -source [get_pins OBUF_SDRAM_CLK/I] [get_ports sdram_clk]
