...
##Pmod Header JA
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33 SLEW FAST DRIVE 24} [get_ports {jalo[1]}]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 24} [get_ports {jalo[2]}]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33 SLEW FAST DRIVE 6} [get_ports {jalo[3]}]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 6} [get_ports {jalo[4]}]
...
##Pmod Header JB
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33 SLEW FAST DRIVE 24} [get_ports {jblo[1]}]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 24} [get_ports {jblo[2]}]
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33 SLEW FAST DRIVE 6} [get_ports {jblo[3]}]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 6} [get_ports {jblo[4]}]
