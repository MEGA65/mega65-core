...
set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS33 SLEW FAST DRIVE 4} [get_ports {eth_txd[0]}]
set_property -dict {PACKAGE_PIN K3 IOSTANDARD LVCMOS33 SLEW FAST DRIVE 4} [get_ports {eth_txd[1]}]
...
set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33 SLEW FAST DRIVE 4} [get_ports eth_txen]
