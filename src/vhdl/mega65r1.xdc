...
set_property -dict { PACKAGE_PIN M18 IOSTANDARD LVCMOS33 DRIVE 16 } [get_ports {column[0]}]
set_property -dict { PACKAGE_PIN L18 IOSTANDARD LVCMOS33 DRIVE 16 } [get_ports {column[1]}]
set_property -dict { PACKAGE_PIN N18 IOSTANDARD LVCMOS33 DRIVE 16 } [get_ports {column[2]}]
set_property -dict { PACKAGE_PIN N19 IOSTANDARD LVCMOS33 DRIVE 16 } [get_ports {column[3]}]
set_property -dict { PACKAGE_PIN N20 IOSTANDARD LVCMOS33 DRIVE 16 } [get_ports {column[4]}]
set_property -dict { PACKAGE_PIN M20 IOSTANDARD LVCMOS33 DRIVE 16 } [get_ports {column[5]}]
set_property -dict { PACKAGE_PIN K13 IOSTANDARD LVCMOS33 DRIVE 16 } [get_ports {column[6]}]
set_property -dict { PACKAGE_PIN K14 IOSTANDARD LVCMOS33 DRIVE 16 } [get_ports {column[7]}]
set_property -dict { PACKAGE_PIN M13 IOSTANDARD LVCMOS33 DRIVE 16 } [get_ports {column[8]}]
set_property -dict { PACKAGE_PIN L13 IOSTANDARD LVCMOS33 DRIVE 2 } [get_ports {row[8]}]
set_property -dict { PACKAGE_PIN K17 IOSTANDARD LVCMOS33 DRIVE 2 } [get_ports {row[7]}]
set_property -dict { PACKAGE_PIN J17 IOSTANDARD LVCMOS33 DRIVE 2 } [get_ports {row[6]}]
set_property -dict { PACKAGE_PIN L14 IOSTANDARD LVCMOS33 DRIVE 2 } [get_ports {row[5]}]
set_property -dict { PACKAGE_PIN L15 IOSTANDARD LVCMOS33 DRIVE 2 } [get_ports {row[4]}]
set_property -dict { PACKAGE_PIN L16 IOSTANDARD LVCMOS33 DRIVE 2 } [get_ports {row[3]}]
set_property -dict { PACKAGE_PIN K16 IOSTANDARD LVCMOS33 DRIVE 2 } [get_ports {row[2]}]
set_property -dict { PACKAGE_PIN M15 IOSTANDARD LVCMOS33 DRIVE 2 } [get_ports {row[1]}]
set_property -dict { PACKAGE_PIN M16 IOSTANDARD LVCMOS33 DRIVE 2 } [get_ports {row[0]}]
