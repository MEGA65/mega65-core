...
# C64 Cartridge port
set_property -dict { PACKAGE_PIN V22 IOSTANDARD LVCMOS33 } [get_ports cart_phi2]; #  output only
set_property -dict { PACKAGE_PIN U21 IOSTANDARD LVCMOS33 } [get_ports cart_dotclock]; # output only
set_property -dict { PACKAGE_PIN W22 IOSTANDARD LVCMOS33 } [get_ports cart_reset]; # output only
set_property -dict { PACKAGE_PIN W20 IOSTANDARD LVCMOS33 } [get_ports cart_nmi]; # input only
set_property -dict { PACKAGE_PIN V18 IOSTANDARD LVCMOS33 } [get_ports cart_irq]; # input only
set_property -dict { PACKAGE_PIN AB18 IOSTANDARD LVCMOS33 } [get_ports cart_dma]; # input only
set_property -dict { PACKAGE_PIN R18 IOSTANDARD LVCMOS33 } [get_ports cart_exrom]; # bidirectional
set_property -dict { PACKAGE_PIN N15 IOSTANDARD LVCMOS33 } [get_ports cart_ba]; # bidirectional
set_property -dict { PACKAGE_PIN AA19 IOSTANDARD LVCMOS33 } [get_ports cart_rw]; # bidirectional
set_property -dict { PACKAGE_PIN R19 IOSTANDARD LVCMOS33 } [get_ports cart_roml]; # bidirectional
set_property -dict { PACKAGE_PIN V17 IOSTANDARD LVCMOS33 } [get_ports cart_romh]; # bidirectional
set_property -dict { PACKAGE_PIN W17 IOSTANDARD LVCMOS33 } [get_ports cart_io1]; # bidirectional
set_property -dict { PACKAGE_PIN U17 IOSTANDARD LVCMOS33 } [get_ports cart_game]; # bidirectional
set_property -dict { PACKAGE_PIN T18 IOSTANDARD LVCMOS33 } [get_ports cart_io2]; # bidirectional
...
set_property -dict { PACKAGE_PIN M18 IOSTANDARD LVCMOS33 DRIVE 16 PULLUP false } [get_ports {column[0]}]
set_property -dict { PACKAGE_PIN L18 IOSTANDARD LVCMOS33 DRIVE 16 PULLUP false } [get_ports {column[1]}]
set_property -dict { PACKAGE_PIN N18 IOSTANDARD LVCMOS33 DRIVE 16 PULLUP false } [get_ports {column[2]}]
set_property -dict { PACKAGE_PIN N19 IOSTANDARD LVCMOS33 DRIVE 16 PULLUP false } [get_ports {column[3]}]
set_property -dict { PACKAGE_PIN N20 IOSTANDARD LVCMOS33 DRIVE 16 PULLUP false } [get_ports {column[4]}]
set_property -dict { PACKAGE_PIN M20 IOSTANDARD LVCMOS33 DRIVE 16 PULLUP false } [get_ports {column[5]}]
set_property -dict { PACKAGE_PIN K13 IOSTANDARD LVCMOS33 DRIVE 16 PULLUP false } [get_ports {column[6]}]
set_property -dict { PACKAGE_PIN K14 IOSTANDARD LVCMOS33 DRIVE 16 PULLUP false } [get_ports {column[7]}]
set_property -dict { PACKAGE_PIN M13 IOSTANDARD LVCMOS33 DRIVE 16 PULLUP false } [get_ports {column[8]}]
set_property -dict { PACKAGE_PIN L13 IOSTANDARD LVCMOS33 DRIVE 2 PULLUP false } [get_ports {row[8]}]
set_property -dict { PACKAGE_PIN K17 IOSTANDARD LVCMOS33 DRIVE 2 PULLUP false } [get_ports {row[7]}]
set_property -dict { PACKAGE_PIN J17 IOSTANDARD LVCMOS33 DRIVE 2 PULLUP false } [get_ports {row[6]}]
set_property -dict { PACKAGE_PIN L14 IOSTANDARD LVCMOS33 DRIVE 2 PULLUP false } [get_ports {row[5]}]
set_property -dict { PACKAGE_PIN L15 IOSTANDARD LVCMOS33 DRIVE 2 PULLUP false } [get_ports {row[4]}]
set_property -dict { PACKAGE_PIN L16 IOSTANDARD LVCMOS33 DRIVE 2 PULLUP false } [get_ports {row[3]}]
set_property -dict { PACKAGE_PIN K16 IOSTANDARD LVCMOS33 DRIVE 2 PULLUP false } [get_ports {row[2]}]
set_property -dict { PACKAGE_PIN M15 IOSTANDARD LVCMOS33 DRIVE 2 PULLUP false } [get_ports {row[1]}]
set_property -dict { PACKAGE_PIN M16 IOSTANDARD LVCMOS33 DRIVE 2 PULLUP false } [get_ports {row[0]}]
set_property -dict { PACKAGE_PIN N22 IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports keyleft]
set_property -dict { PACKAGE_PIN M22 IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports keyup]
...
set_property -dict { PACKAGE_PIN R2 IOSTANDARD LVCMOS33 } [get_ports hdmi_de]; # Data Enable
