...
set_property -dict { PACKAGE_PIN L13 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {row[8]}]
set_property -dict { PACKAGE_PIN K17 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {row[7]}]
set_property -dict { PACKAGE_PIN J17 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {row[6]}]
set_property -dict { PACKAGE_PIN L14 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {row[5]}]
set_property -dict { PACKAGE_PIN L15 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {row[4]}]
set_property -dict { PACKAGE_PIN L16 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {row[3]}]
set_property -dict { PACKAGE_PIN K16 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {row[2]}]
set_property -dict { PACKAGE_PIN M15 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {row[1]}]
set_property -dict { PACKAGE_PIN M16 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {row[0]}]
