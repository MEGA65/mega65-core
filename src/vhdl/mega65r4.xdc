...
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports fa_down_o]  # DBG3
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS33} [get_ports fa_up]
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports fa_up_o] # DBG1
set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS33} [get_ports fa_left]
set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS33} [get_ports fa_left_o] # DBG2
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS33} [get_ports fa_right]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports fa_right_o] # DBG5
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports fa_fire]
set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS33} [get_ports fa_fire_o] # DBG0

# Joystick port B
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports fb_down]
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports fb_down_o] # DBG6
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports fb_up]
set_property -dict {PACKAGE_PIN N20 IOSTANDARD LVCMOS33} [get_ports fb_up_o] # DBG4
set_property -dict {PACKAGE_PIN F21 IOSTANDARD LVCMOS33} [get_ports fb_left]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports fb_left_o] # DBG9
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports fb_right]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports fb_right_o] # DBG8
set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS33} [get_ports fb_fire]
set_property -dict {PACKAGE_PIN N19 IOSTANDARD LVCMOS33} [get_ports fb_fire_o] # DBG7
...
## Pmod Header P1
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p1lo[0]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p1lo[1]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p1lo[2]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p1lo[3]}]
set_property -dict { PACKAGE_PIN A18 IOSTANDARD LVCMOS33 } [get_ports {p1hi[0]}] # B16_L17_P
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p1hi[1]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p1hi[2]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p1hi[3]}]

## Pmod Header P2
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p2lo[0]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p2lo[1]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p2lo[2]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p2lo[3]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p2hi[0]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p2hi[1]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p2hi[2]}]
set_property -dict { PACKAGE_PIN  IOSTANDARD LVCMOS33 } [get_ports {p2hi[3]}]
