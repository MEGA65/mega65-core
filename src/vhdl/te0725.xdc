...
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[44]}]    # Real pin = F6
set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[45]}]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[46]}]
set_property -dict {PACKAGE_PIN C7 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[47]}]
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[48]}] # Real pin = D8
...
set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[53]}] # Real pin T8
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[54]}] # Real pin R8a
...
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[57]}] # Real pin V9
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[58]}] # Real pin U9
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[59]}] # Real pin T1
...
set_property -dict {PACKAGE_PIN U4 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[71]}]
...
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[74]}]
...
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[83]}] # Real pin P4
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[84]}] # Real pin P3
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[85]}] # Real pin N4
set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[86]}] # Real pin M4
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[87]}] # Real pin T1
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[88]}] # Real pin R1
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[89]}] # Real pin R2
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[90]}] # Real pin P2
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[91]}] # Real pin N1
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[92]}] # Real pin N2
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[93]}] # Real pin M1
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[94]}] # Real pin L1
...
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[97]}] # Real pin M3
set_property -dict {PACKAGE_PIN R10 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[98]}] # Real pin M2
