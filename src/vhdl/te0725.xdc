...
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[9]}]
...
set_property -dict {PACKAGE_PIN U4 IOSTANDARD LVCMOS33 SLEW FAST DRIVE 16} [get_ports {fpga_pins[71]}]
...
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVCMOS33 SLEW FAST DRIVE 16} [get_ports {fpga_pins[74]}]
