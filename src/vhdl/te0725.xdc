...
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[29]}]
set_property -dict {PACKAGE_PIN D5 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[30]}] 
...
set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS33} [get_ports {fpga_pins[59]}]
...
set_property -dict {PACKAGE_PIN P4 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[83]}]
set_property -dict {PACKAGE_PIN P3 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[84]}]
set_property -dict {PACKAGE_PIN N4 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[85]}]
set_property -dict {PACKAGE_PIN M4 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[86]}]
set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[87]}]
set_property -dict {PACKAGE_PIN R1 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[88]}]
set_property -dict {PACKAGE_PIN R2 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[89]}]
set_property -dict {PACKAGE_PIN P2 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[90]}]
set_property -dict {PACKAGE_PIN N1 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[91]}]
set_property -dict {PACKAGE_PIN N2 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[92]}]
set_property -dict {PACKAGE_PIN M1 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[93]}]
set_property -dict {PACKAGE_PIN L1 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[94]}]
...
set_property -dict {PACKAGE_PIN M3 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[97]}]
set_property -dict {PACKAGE_PIN M2 IOSTANDARD LVCMOS18} [get_ports {fpga_pins[98]}]
