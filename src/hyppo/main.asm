...
;; /*  -------------------------------------------------------------------
;;     Hypervisor trap routines $8200 - $BAFF
;;     ---------------------------------------------------------------- */
        * = Traps_Start
...
return_from_flashmenu:
        ...
        ;; This jmp lands on the very next instruction, so it's a no-op on
        ;; its own. May be magic here so left in place anyway on Gardners' request, 
        ;; since removing it isn't worth relitigating and we have room to spare.
