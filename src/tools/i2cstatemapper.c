...
// so we have to schedule multiple jobs.
  ...
  { 0x48, 0x00, 0x01, 0x20, "IO Expander #4 regs 0-1" }, 
  { 0x48, 0x02, 0x03, 0x22, "IO Expander #4 regs 2-3" }, 
  { 0x48, 0x04, 0x05, 0x24, "IO Expander #4 regs 4-5" }, 
  { 0x48, 0x06, 0x07, 0x26, "IO Expander #4 regs 6-7" }, 
