...
@filename=mf_screens\n\n
                                     ...
                                     !endtext on a single line. A comment is a line starting with a / (forward slash). The screen must have a screen name, a size in characters
...
!endtext\n\n
                                     ...
                                     With the 'formatstring' switch you can make the screen a format string thatb can be used with mhx_writef. There is also a '{EOS}' format character
