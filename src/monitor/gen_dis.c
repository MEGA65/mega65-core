...
#define GEN_OPCODE_PROPERTIES(_op_) \
            ...
            _op_(LDY,2,imm),_op_(LDA,2,inx),_op_(LDX,2,imm),_op_(LDZ,2,imm),_op_(LDY,2,imp),_op_(LDA,2,imp),_op_(LDX,2,imp),_op_(SMB,2,imp),_op_(TAY,1,imp),_op_(LDA,2,imm),_op_(TAX,1,imp),_op_(LDZ,2,imp),_op_(LDY,3,imp),_op_(LDA,3,imp),_op_(LDX,3,imp),_op_(BBS,3,imp), \
