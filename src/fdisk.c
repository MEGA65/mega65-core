			 ...
			 uint32_t data_sectors, uint32_t fs_sectors_per_fat)
{
  ...
  uint8_t bytes[224]={
    ...
    // OEM String
    0x6d, 0x6b, 0x66, 0x73, 0x2e, 0x66, 0x61, 0x74,
    ...
    0x00, 0x00, // Total logical sectors (0 for FAT32)
    0xf8, // Disk type (0xF8 = hard disk)
    0x00, 0x00, // Sectors per FAT for FAT12/16 (0 for FAT32)
    0x20, 0x00, // Sectors per track (== 32)
    0x40, 0x00, // Number of heads for CHS drives, zero for LBA
    0x81, 0x00, // Number of hidden sectors before partition. Should be 0 if logical sectors == 0
    
    0x00, 0x00,
    0x00, 0xe8, 0x0f, 0x00, 0xf8, 0x03, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x02, 0x00 ,0x00, 0x00,
    0x01, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ,0x00, 0x00,
    0x80, 0x00, 0x29, 0x6d, 0x66, 0x62, 0x61, 0x4c,
    0x4f, 0x55, 0x44, 0x20, 0x20, 0x20 ,0x20, 0x20,
    0x20, 0x20, 0x46, 0x41, 0x54, 0x33, 0x32, 0x20,
    0x20, 0x20, 0x0e, 0x1f, 0xbe, 0x77 ,0x7c, 0xac,
